...
const Navbar = () => {
  return (
    <>
            ...
            <a className="navbar-brand textColor" href="#">Sanjay Consult</a>
  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav  mx-auto me-5">
      ...
      <li className="nav-item dropdown mx-3">
        <a className="nav-link dropdown-toggle text-dark"  id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
          Servises
        </a>
